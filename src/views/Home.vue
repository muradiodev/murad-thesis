<template>
  ...
  <div class="container">
    <ul class="nav">
      <li class="nav-item" v-for="(m, i) in menuData" :key="i">
        <router-link class="nav-link" aria-current="page" :to="m.link">{{
          m.label
        }}</router-link>
      </li>
    </ul>
  ...
  <section
    :class="{
      ...
      active: journeyIsActive && activeModule === 1,
    }"
    id="section_1"
  >
    ...
    <div
      class="tent"
      v-if="activeModule > 0 && activeModule !== 1"
      @click="activateModule(1)"
    ></div>
  </section>
  ...
  <section
    :class="{
      'journey-enabled': journeyIsActive,
      active: journeyIsActive && activeModule === 2,
    }"
  ...
  >
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="mt-3">
            ...
            <button
              class="btn btn-sm btn-outline-primary me-3"
              @click.prevent="activateModule(3)"
            >
              next
            </button>
          </div>
    ...
    <div
      class="tent"
      v-if="activeModule > 0 && activeModule !== 2"
      @click="activateModule(2)"
    ></div>
  </section>
  ...
  <section
    :class="{
      'journey-enabled': journeyIsActive,
      active: journeyIsActive && activeModule === 3,
    }"
    id="section_3"
  >
    ...
    <div
      class="tent"
      v-if="activeModule > 0 && activeModule !== 3"
      @click="activateModule(3)"
    ></div>
  </section>
  ...
  <Modal
    v-if="personalInfoModalIsOpen"
    size="lg"
    title="Start journey"
    @modalClose="personalInfoModalIsOpen = false"
    :z-index="960"
  >
